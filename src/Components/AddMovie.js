  ...
  <div class="container px-5 py-8 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2">
          <div class="relative">
            ...
            <input type="text"
             ...
             name="name" 
             value={from.title}
             onChange={(e)=>setFrom({...from, title:e.target.value})}
        ...
        <div class="p-2 w-full">
          <div class="relative">
            ...
            <input
             ...
             name="message"
             value={from.image}
             onChange={(e)=>setFrom({...from, image:e.target.value})}
              class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500
              focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 
              py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
          </div>
        ...
        <div class="p-2 w-full">
          <div class="relative">
            ...
            <textarea
             ...
             onChange={(e)=>setFrom({...from, description:e.target.value})}
        ...
        <div class="p-2 w-full">
          <button onClick= {addMovie}class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 
          focus:outline-none hover:bg-indigo-600 rounded text-lg">
           { loadings ? <TailSpin height={25} color='white'/> : 'Add'}
            </button>
        </div>
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-indigo-500">Sahinrd60@email.com</a>
          <p class="leading-normal my-5">Bhaduriapara
            <br/>MSD, PIN 742303
          </p>
